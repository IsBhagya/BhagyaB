...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll selected" href="#ser">Selected Coach </a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll cshow" href="#ser">Select Coach </a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-5" id="sresult">
    <div class="card" >
      <h2 class="text-center "> Selected Coach Details </h2>
      <div class="card-header bg-info">
        <div class="row">
          <div class="col-md-3">
            <h3 class="text-center text-white">Coach Name</h3>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico text-white">
                      ...
                      <li><span class="ion-ios-telephone"></span> 9019865811</li>
