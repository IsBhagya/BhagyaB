...
<body id="page-top">
      ...
      <div class='table-cell'>
        <div class='container'>
          ...
          <p class='intro-subtitle'><span class='text-slider-items'>$wdesc</span><strong class='text-slider'></strong></p>
           <p class='display-6 color-d'><b>Payment</b>: 50k </p>
  ...
  <section id="service" class="services-mf route">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              Dance is not just a art, it's emotion of every Indian
            </p>
      ...
      <div class="row">
        <div class="col-md-3 dnc11" did="Bharatanatyam" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc21" did="Kathakali" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc31" did="Folk" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc41"did="Ballet" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc51"did="Belly Dance" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc61 "did="Free Style" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc71"did="Pole Dance" style="cursor: pointer;">
        ...
        <div class="col-md-3 dnc81"did="Salsa" style="cursor: pointer;">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Workshop Name</span> / <span class="w-date">09 Mar. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Web Design</span> / <span class="w-date">09 Mar. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Web Design</span> / <span class="w-date">29 Feb. 2025</span>
                    </div>
                  </div>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
           ...
           <div class="testimonial-box">
              <div class="author-test">
                <img src="img\Bhagya.jpg" alt="" class="rounded-circle b-shadow-a" width="150" height="150">
                <span class="author">Bhagya</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                We are inspired by the Bharatanatyam dance style 
                </p>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico text-white">
                      <li><span class="ion-ios-location"></span>5P-704 Provident Sunworth Vijaypur</li>
                      <li><span class="ion-ios-telephone"></span> +919608472701</li>
                      <li><span class="ion-email"></span> bhagya@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
