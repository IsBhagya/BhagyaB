    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/tlogin.php">Coach</a>
          </li>
           <li class="nav-item">
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">NAVARASA</span> / <span class="w-date">09 Mar. 2024</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">DANSPIRATION</span> / <span class="w-date">27 Feb. 2024</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">VERVE</span> / <span class="w-date">2 Oct. 2024</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">DROPBEAT</span> / <span class="w-date">1 Sept. 2024</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">D-EVOLVE</span> / <span class="w-date">7 Nov. 2024</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">ZEST</span> / <span class="w-date">2 Feb. 2025</span>
                    </div>
                  </div>
